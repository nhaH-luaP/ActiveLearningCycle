def get_args_parser(add_help=True):
    ...
    parser.add_argument("--num_labeld_samples", default=10, type=int)
    ...
    parser.add_argument("--scenario", default="pool_based", type=str)

    parser.add_argument("--t_scaling", default=True, type=bool)
